...
export class EditarUsuarioAdminComponent implements OnInit {
  ...
  crearFormulario(){
    this.loginForm = new FormGroup({
      ...
      tipo: new FormControl(this.usuarioBuscado.tipoUsuario.id),
  ...
  modificarUsuario(){
        ...
        this.usuarioService.actualizarAdminUsuario(this.idUsuario, this.loginForm.controls["nombre"].value, this.loginForm.controls["nombreUsuario"].value, this.loginForm.controls["email"].value, this.loginForm.controls["telefono"].value, this.loginForm.controls["direccion"].value, this.loginForm.controls["cp"].value, this.loginForm.controls["localidad"].value, this.loginForm.controls["provincia"].value, this.loginForm.controls["altura"].value, this.loginForm.controls["tipo"].value, this.foto).subscribe(data => {
          ...
          if (data["0"] == "Error") {
            ...
            // alert("Usuario modificado corectamente");
            this.editado = 'si'
            setTimeout(() => {

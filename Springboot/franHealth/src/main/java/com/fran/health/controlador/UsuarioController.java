...
;				}
		...
		public DTO listarAutenticado(HttpServletRequest request) {
			...
			if (u != null) {
				...
				dtoUsuario.put("idTipo", u.getIdTipousuario());
			}else {
				dtoUsuario.put("log", "No logueado");
			}
		...
		public DTO buscarUsuario(@PathVariable(value="id") int id) {
			...
			dtoUsuario.put("sexo", u.getSexo());
			dtoUsuario.put("foto", u.getFoto());
			dtoUsuario.put("tipoUsuario", u.getIdTipousuario());
		...
		@GetMapping("/listarAsincusuarios/{id}")
		public DTO listarAsincUsuarios(HttpServletRequest request, @PathVariable(value="id") String id) {	
			DTO dto = new DTO();
			//Creamos una lista de usuarios para traernos todos los usuarios
			List<Usuario>usuarios = usuarioRepo.findUsuarioAsincrono(id);
		...
		@PostMapping(path="/modificarAdminUsuario",consumes=MediaType.APPLICATION_JSON_VALUE)
		public DTO  actualizarAdminmodulo(@RequestBody datosActualizarAdminUsuario d, HttpServletRequest request) {
				...
				try {
					...
					doc.setProvincia(d.provincia);
					doc.setAltura(d.altura);
					doc.setIdTipousuario(tipoUsuarioRepo.findById(d.tipo));
					doc.setFoto(d.foto);
					//Guardamos el usuario pasando el mismo al método save de usuarioRepo
					usuarioRepo.save(doc);
					//Guardamos en dto, el en indice "0" el valor "Perfecto"
...
class datosRegistroUsuario{
	String nombre, nombreUsu, email, contrasenna, fecha_nac, telefono, direccion, cp, localidad, provincia, altura, sexo;
	byte[] foto;
	
	public datosRegistroUsuario(String nombre, String nombreUsu,String email,String contrasenna,String fecha_nac, String telefono,String direccion,String cp,String localidad,String provincia,String altura,String sexo, byte[] foto) {
		super();
		this.nombre = nombre;
...
class DatosAutenticacionUsuario{
	 ...
	 * Constructor
	 */
	public DatosAutenticacionUsuario(String email, String contrasenna) {
		super();
		this.email = email;
		this.contrasenna = contrasenna;
	}
...
class datosActualizarUsuario{
	String nombre, nombreUsu, email, telefono, direccion, cp, localidad, provincia, altura, sexo;
	byte[] foto;
	int id ;
	
	public datosActualizarUsuario(int id, String nombre, String nombreUsu,String email, String telefono,String direccion,String cp,String localidad,String provincia,String altura,String sexo, byte[] foto) {
		super();
		this.id = id;
		this.nombre = nombre;
		this.nombreUsu = nombreUsu;
...
class datosActualizarAdminUsuario{
	String nombre, nombreUsu, email, telefono, direccion, cp, localidad, provincia, altura;
	byte[] foto;
	int id, tipo ;
	
	public datosActualizarAdminUsuario(int id, String nombre, String nombreUsu,String email, String telefono,String direccion,String cp,String localidad,String provincia,String altura,int tipo, byte[] foto) {
		super();
		this.id = id;
		this.nombre = nombre;
		this.nombreUsu = nombreUsu;
